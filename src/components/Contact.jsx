...
const Contact = () => {
    return ( 
      <div className="h-[calc(100vh-80px)] grid grid-rows-4 gap-2">
        <div className="row-span-1 place-self-center flex flex-col justify-center items-center">
          <h1 className="mb-7 font-normal text-center text-8xl text-gray-200">Contacto</h1>
          <h4 className="text-2xl"> Si ya llegaste hasta acá, lo mejor seria que sigamos en contacto</h4>
        </div>
        ...
        <div className="row-span-1 my-5 flex flex-col justify-center items-center">
          <p>
            Espero hayas disfrutado mucho este paseo
            ¡Gracias, vuelva prontos!
          </p>
         <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" target="_blank"><FaHandSpock title="Live long and prosper" className="text-3xl text-emerald-400" /></a> 
        </div>
    </div>
     );
}
